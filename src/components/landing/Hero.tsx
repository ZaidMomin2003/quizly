          ...
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            ...
            <div className="mt-8 flex flex-col gap-4 min-[400px]:flex-row justify-center">
                <Button asChild size="lg">
                  <Link href="/signup" className="group relative overflow-hidden shadow-lg shadow-primary/20 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-background px-8 text-sm font-medium text-white backdrop-blur-3xl">
