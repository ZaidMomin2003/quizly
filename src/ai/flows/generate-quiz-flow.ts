...
const prompt = ai.definePrompt({
  ...
  2. Provide exactly 4 multiple-choice options, each prefixed with "A.", "B.", "C.", or "D.".
  3. Indicate the correct answer by providing only the corresponding letter (A, B, C, or D).
